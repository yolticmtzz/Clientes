exports = {
  ...
  onTicketCreateHandler: async function (args) {
    ...
    console.log("Payload de verificação do SLA");
    ...
    if (Object.values(fieldsObtained).every(Boolean)) {
      ...
      await $request.post("https://dor-backend-homologation.azurewebsites.net/api/TimeStamp", request_registerTimestampNull)
        .then(
          function (data) {
            console.log(data.status);
        ...
        .then(
          function (data_customfields) {
            ...
            if (searchedTimestamp !== null) {
              ...
              else if (searchedTimestamp.timestamp.client !== customFields["cf_cliente"]) {
              ...
              // If the cliente is the same
                ...
                cliente_value = searchedTimestamp.timestamp.client;
